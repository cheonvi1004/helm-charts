# Metabase with Open Service Broker for SAKURA Cloud
...
- [Open Service Broker for SAKURA Cloud](https://github.com/sacloud/open-service-broker-sacloud)
...
|------------------------|------------------------------------------------------------|-------------------|
| database.type          | Backend database type[postgres or mariadb]                 | postgres          |
| database.switchID      | Switch ID for Database Appliance of SAKURA Cloud           | -|
| database.ipaddress     | IP address for Database Appliance of SAKURA Cloud          | -|
| database.maskLen       | Network mask length for Database Appliance of SAKURA Cloud | -|
| database.defaultRoute  | Default route IP address for Database Appliance of SAKURA Cloud| -|
...
```bash
$ helm install --name my-release -f values.yaml sacloud/metabase
```
